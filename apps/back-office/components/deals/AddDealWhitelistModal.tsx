...
import { useAddDealWhitelistMember } from '../../hooks/deals/useAddDealWhitelistMember';
import clsx from 'clsx';
import { toast } from 'react-toastify';

interface AddDealWhitelistModalProps {
  isOpen: boolean;
  onClose: () => void;
  existingMemberUids: string[];
}

export const AddDealWhitelistModal: React.FC<AddDealWhitelistModalProps> = ({
  isOpen,
  onClose,
  existingMemberUids,
}) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Member added to deals whitelist');
      resetAll();
      onClose();
    } catch (error: any) {
      ...
      <div className="w-full max-w-lg rounded-lg bg-white shadow-xl">
        <div className="border-b border-gray-200 px-6 py-4">
          <div className="flex items-center justify-between">
            <h3 className="text-lg font-semibold text-gray-900">Add Member to Deals Whitelist</h3>
        ...
        <div className="px-6 py-6">
          <form id="add-deal-whitelist-form" onSubmit={handleSubmit} className="space-y-4">
