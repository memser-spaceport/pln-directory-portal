...
export const ARTICLE_CATEGORY_DESCRIPTIONS: Record<ArticleCategory, string> = {
  ...
  'US Visa / Immigration':
    'Visa options, founder-specific immigration strategies, and working with immigration counsel.',
  'Press & PR': 'How to get media coverage, write press releases, and build a public narrative for your startup.',
  'Hire Handbook':
    'How to find, evaluate, compensate, and retain the right people as you scale from zero to your first team.',
  'Seed / Series A':
  ...
  'Crypto & Token Launch':
    'Token design, regulatory considerations, launch mechanics, and community building for Web3.',
};
