...
export const IGNORED_URLS_FOR_CONCEALID = ['/v1/husky/chat/assistant', '/v1/husky/chat/feedback', '/v1/husky/chat/contextual', '/v1/husky/chat/analytical', '/v1/husky/chat/additional-info'];
...
**Generated SQL:**
[
  "SELECT DISTINCT m.\"id\", m.\"name\", m.\"teamName\", m.\"role\", m.\"projectsContributed\", m.\"skills\", m.\"type\" FROM \"Member\" m JOIN \"Team\" t ON m.\"teamName\" = t.\"name\" WHERE 'strategy' = ANY(m.\"skills\") AND 'tableland' = ANY(t.\"projectsContributed\");"
]
...
**Generated SQL:**
[
  "SELECT DISTINCT m.\"id\", m.\"name\", m.\"teamName\", m.\"role\", m.\"projectsContributed\", m.\"skills\", m.\"type\" FROM \"Member\" m JOIN \"MemberEventParticipation\" mep ON LOWER(m.\"name\") = LOWER(mep.\"name\") WHERE EXISTS (SELECT 1 FROM unnest(mep.\"events\") AS event WHERE event ILIKE '%denver%');"
]
...
**Generated SQL:**
[
  "SELECT \"id\", \"name\", \"location\", \"startDate\", \"endDate\", \"hosts\", \"topics\", \"speakers\", \"type\" FROM \"EventInfo\" WHERE \"startDate\" > NOW() AND EXISTS (SELECT 1 FROM unnest(\"topics\") AS topic WHERE topic ILIKE '%networks%');"
]
...
**Generated SQL:**
[
  "SELECT t.\"id\", t.\"name\", t.\"industries\", t.\"fundingStage\", t.\"projectsContributed\", t.\"type\" FROM \"Team\" t JOIN \"FocusArea\" f ON t.\"name\" = ANY(f.\"teams\") WHERE f.\"name\" ILIKE '%public goods%';",
  "SELECT p.\"id\", p.\"name\", p.\"lookingForFunding\", p.\"maintainingTeam\", p.\"type\" FROM \"Project\" p JOIN \"FocusArea\" f ON p.\"name\" = ANY(f.\"projects\") WHERE f.\"name\" ILIKE '%public goods%';"
]
...
**Generated SQL:**
[
  "SELECT \"id\", \"name\", \"lookingForFunding\", \"maintainingTeam\", \"type\" FROM \"Project\" WHERE \"lookingForFunding\" = TRUE;"
]
...
**Generated SQL:**
[
  "SELECT t.\"id\", t.\"name\", t.\"industries\", t.\"fundingStage\", t.\"projectsContributed\", t.\"type\" FROM \"Team\" t JOIN \"FocusArea\" f ON t.\"name\" = ANY(f.\"teams\") WHERE f.\"name\" ILIKE '%ai research%';"
]
...
**Generated SQL:**
[
  "SELECT DISTINCT m.\"id\", m.\"name\", m.\"teamName\", m.\"role\", m.\"projectsContributed\", m.\"skills\", m.\"type\" FROM \"Member\" m JOIN \"FocusArea\" f ON EXISTS (SELECT 1 FROM unnest(m.\"projectsContributed\") p WHERE p = ANY(f.\"projects\")) WHERE f.\"name\" ILIKE '%healthtech%';"
]
...
**Generated SQL:**
[
  "SELECT DISTINCT e.\"id\", e.\"name\", e.\"location\", e.\"startDate\", e.\"endDate\", e.\"hosts\", e.\"topics\", e.\"speakers\", e.\"type\" FROM \"EventInfo\" e JOIN \"MemberEventParticipation\" mep ON e.\"name\" = ANY(mep.\"events\") WHERE LOWER(mep.\"name\") ILIKE '%john doe%';"
]
