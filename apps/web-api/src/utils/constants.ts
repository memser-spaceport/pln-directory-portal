...
export const MEMBER_APPROVED_SUBJECT = 'Your profile on Protocol Lab’s LabOS is approved';
...
export const ASK_CREATED_SUBJECT = 'A new ask created';
export const ASK_CLOSED_SUBJECT = 'An ask closed';
