/*
  ...
  - A unique constraint covering the columns `[latitude,longitude]` on the table `PLEventLocation` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "PLEventLocation_latitude_longitude_key" ON "PLEventLocation"("latitude", "longitude");
