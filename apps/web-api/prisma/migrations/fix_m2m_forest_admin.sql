...
ALTER TABLE "_MemberToSkill" DROP CONSTRAINT IF EXISTS "_MemberToSkill_AB_primary";
ALTER TABLE "_MemberToSkill"
ADD CONSTRAINT "_MemberToSkill_AB_primary"
PRIMARY KEY("A", "B");

ALTER TABLE "_IndustryTagToTeam" DROP CONSTRAINT IF EXISTS "_IndustryTagToTeam_AB_primary";
ALTER TABLE "_IndustryTagToTeam"
ADD CONSTRAINT "_IndustryTagToTeam_AB_primary"
PRIMARY KEY("A", "B");

ALTER TABLE "_MembershipSourceToTeam" DROP CONSTRAINT IF EXISTS "_MembershipSourceToTeam_AB_primary";
ALTER TABLE "_MembershipSourceToTeam"
ADD CONSTRAINT "_MembershipSourceToTeam_AB_primary"
PRIMARY KEY("A", "B");

ALTER TABLE "_TeamToTechnology" DROP CONSTRAINT IF EXISTS "_TeamToTechnology_AB_primary";
