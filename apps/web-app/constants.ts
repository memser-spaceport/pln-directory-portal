...
export const APP_ANALYTICS_EVENTS = {
  ...
  IRL_GUEST_LIST_HEADER_SEARCH:'irl-guest-list-header-search',
  IRL_GUEST_LIST_TABLE_HEADER_SORT_COLUMN_CLICKED:"irl-guest-list-table-header-sort-column-clicked",
