...
const faqItems = [
  ...
  {
    triggerText: 'Q3. I want to join the network, what can I do?',
    content:
  ...
  {
    triggerText: 'Q4. What is Spaceport?',
    content:
