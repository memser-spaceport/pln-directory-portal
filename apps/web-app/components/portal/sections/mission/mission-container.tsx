...
export const MissionContainer = ({ children }: TMissionContainerProps) => {
  return (
    <section className="relative flex flex-col items-center justify-center overflow-hidden bg-[url('/assets/images/portal/mission-bg.jpg')] bg-cover bg-center bg-no-repeat bg-origin-border px-6 pb-10 pt-[104px] text-center md:px-16 md:pb-[152px] md:pt-48">
