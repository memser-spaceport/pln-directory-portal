...
export const NetworkSpotlight = ({ videoDetails, playlistDetails }) => {
    ...
    return (
        <>
            <section className="border p-[24px] ">
                <p className="font-extrabold text-[24px] leading-[28px] pb-[10px]">{NW_SPOTLIGHT_CONSTANTS.HEADING}</p>
                <div className="flex flex-col md:flex-row justify-evenly gap-[16px]">
                    <div className="w-[350px] h-[328px] border rounded-[8px] bg-[#F1F5F9] p-[20px]">
                        <div>
                            ...
                            />
                            <p className="text-[16px] font-semibold leading-6 text-[#0F172A]">{NW_SPOTLIGHT_CONSTANTS.BLOG_TITLE}</p>
                            <div className="pt-8">
                                <PortalButton
                    ...
                    </div>
                    {
                        (videoDetails && <div className="w-[350px] h-[328px] border rounded-[8px] bg-[#F1F5F9] p-[20px]">
                            ...
                            <div className="flex flex-col">
                                ...
                                <div>
                                    <p className="text-[16px] font-semibold leading-6 text-[#0F172A]">{videoDetails['items'][0].snippet.title}</p>
                                </div>
                                <div>
                                    <div className="pt-1">
                                        <button
                    ...
                    }
                    {
                        (playlistDetails && <div className="w-[350px] h-[328px] border rounded-[8px] bg-[#F1F5F9] p-[20px]">
                            <div>
                                ...
                                />
                                <p className="text-[16px] font-semibold leading-6 text-[#0F172A]">{playlistDetails['items'][0].snippet.title}</p>
                                <div className="pt-14">
                                    <PortalButton
