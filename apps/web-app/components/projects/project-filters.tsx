...
export default function ProjectsFilter({
  ...
  return (
    <>
      ...
      <div className=" h-[calc(100vh_-_148px)] pl-[37px] overflow-y-auto px-[20px] focus-within:outline-none focus:outline-none focus-visible:outline-none">
