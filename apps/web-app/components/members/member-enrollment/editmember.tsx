...
function validateContributionForm(fValues) {
  ...
  exps.forEach((exp, expIndex) => {
    if(exp.projectName.trim() === '') {
      ...
      formErrors.push({id: expIndex, name: `Project ${exp.projectName ? exp.projectName : expIndex + 1}`, field: 'date', error: "Your contribution cannot start and end in the same month and year"})
    }
  })
