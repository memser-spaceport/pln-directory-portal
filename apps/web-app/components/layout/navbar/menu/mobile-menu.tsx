      ...
      {MENU_ITEMS.map((item) => {
        ...
        return (
          <li key={item.path}>
            <Link href={item.path}>
              <a
                className={`on-focus h-[60px] group flex flex-col items-center rounded-lg px-3 py-2.5 text-sm hover:text-slate-900 focus:text-slate-900 ${
              ...
              >
                ...
                {item.name === 'IRL Gatherings' && <img src='/assets/images/icons/beta-logo.svg' alt='beta logo'/>}
              </a>
            </Link>
          </li>
        );
